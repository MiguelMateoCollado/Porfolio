...
export default function Home() {
  return (
    <section className="container min-h-screen leading-relaxed text-white mx-auto grid grid-cols-2 max-md:py-14 max-md:gap-y-2  content-center ">
      ...
      <div className="col-span-1 max-lg:text-center content-center max-lg:col-span-2 gap-4 gap-y-2 leading-relaxed flex flex-col justify-center">
        <h1 className=" max-lg:text-3xl max-lg:py-2 md:text-4xl antialiased font-bold tracking-tight text-balance text-[#FBFAF8]">
          Hola. Mi nombre es  <br /><span className="text-[#d33e43] max-md:text-4xl text-5xl ">Miguel Angel Mateo</span>
        </h1>
        <AnimateText />
